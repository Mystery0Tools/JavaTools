...
data class Pair8<T1, T2, T3, T4, T5, T6, T7, T8>(
    ...
    override fun toString(): String =
        "(first=$first, second=$second, third=$third, fourth=$fourth, fifth=$fifth, sixth=$sixth, seventh=$seventh, eighth=$eighth)"
}
...
data class Pair9<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...
    override fun toString(): String =
        "(first=$first, second=$second, third=$third, fourth=$fourth, fifth=$fifth, sixth=$sixth, seventh=$seventh, eighth=$eighth, ninth=$ninth)"
}
...
data class Pair10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
    ...
    override fun toString(): String =
        "(first=$first, second=$second, third=$third, fourth=$fourth, fifth=$fifth, sixth=$sixth, seventh=$seventh, eighth=$eighth, ninth=$ninth, tenth=$tenth)"
}